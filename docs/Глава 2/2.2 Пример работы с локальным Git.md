## [[2.1 Основные команды и способы работы с локальным Git.md#10. Настройка Git|Предварительная настройка Git]]
...
## [[2.1 Основные команды и способы работы с локальным Git.md#1. Инициализация репозитория|1. Создание проекта]] [[2.1 Основные команды и способы работы с локальным Git.md#3. Создание коммитов|и первый коммит]]
...
## [[2.1 Основные команды и способы работы с локальным Git.md#5. Работа с ветками|4. Работа с ветками]]
...
gitGraph
   ...
   commit id: "Коминт 3"
```
## [[2.1 Основные команды и способы работы с локальным Git.md#6. Слияние веток|5. Слияние веток]]
...
## [[2.1 Основные команды и способы работы с локальным Git.md#4. Просмотр истории|7. Просмотр истории]]
...
## [[2.1 Основные команды и способы работы с локальным Git.md#8. Работа с метками (tags]]|8.%20Работа%20с%20тегами)
...
```
---
[[2.1 Основные команды и способы работы с локальным Git.md|Назад]] | [[3.1 Основные команды и способы работы с удаленным Git.md|Вперёд]]